...
class BLEHourRotationOp: BaseOperation {
    override func mainAction() {
        ...
        let _ = BLECenter.shared.pointerRotation(pointer: .pointerHour, direction: .clockwise, angle: 360, callback: { (success, error) in
